...
namespace Shop.Api.Utils
{
    ...
    public static  class SMSender
    {
        ...
        private static bool Send(string mobile,string template,string param)
        {
            var result = true;
        ...
        /// <returns></returns>
        public static bool SendMsgCode(string mobile,string code)
        {
            return Send(mobile, "SMS_85900143", "{\"code\":\""+code+"\"}");
        }
    }
}