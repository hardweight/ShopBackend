...
namespace Xia.Common.Exceptions
{
    /// <summary>
    /// 框架异常类
    /// </summary>
    ...
    public class XiaException : Exception
    {
        ...
        public XiaException(string message)
            : base(message)
        { }
        ...
        public XiaException(string message, Exception inner)
            : base(message, inner)
        { }
        ...
        protected XiaException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        { }
    }
}